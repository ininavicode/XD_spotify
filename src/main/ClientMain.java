...
public class ClientMain {
    ...
    static final private int MAX_SONGS_SUGESTED = 9;
    static final private int SONG_NAME_ROW = 11;
    static final private int TEXT_INPUT_ROW = 13;
    static final private int TIME_BAR_ROW = 15;
    ...
    static private int menuState = 0, lastMenuState = -1;
        ...
        while (true) {
            switch (menuState) {
                case MENU_TEXT_INPUT:
                    ...
                    if (lastMenuState == MENU_REPRODUCING) {
                        menu.clearScreen();
                    ...
                    if (lastMenuState == MENU_SEARCH_ENGINE_REQUEST) {
                ...
                case MENU_REPRODUCING:
                    ...
                    if (lastMenuState != MENU_REPRODUCING) {
                        ...
                        lastMenuState = MENU_REPRODUCING;
                ...
                case MENU_REQUEST_SELECTED_SONG:
                    if (lastMenuState != MENU_REQUEST_SELECTED_SONG) {
                        lastMenuState = MENU_REQUEST_SELECTED_SONG;
                    }
                ...
                case MENU_SEARCH_ENGINE_REQUEST:
                    if (lastMenuState != MENU_SEARCH_ENGINE_REQUEST) {
                        lastMenuState = MENU_SEARCH_ENGINE_REQUEST;
                    }
